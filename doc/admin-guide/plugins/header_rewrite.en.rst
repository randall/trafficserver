...
-----------------------------
You can concatenate values using strings, condition values and variable expansions via the ``+`` operator. The elements in the concatenation must be enclosed in double quotes ``"``::
