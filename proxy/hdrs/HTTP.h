...
enum HTTPStatus {
  ...
  HTTP_STATUS_UNKNOWN_ERROR                  = 520,
  HTTP_STATUS_ORIGIN_DOWN                    = 521,
  HTTP_STATUS_CONNECTION_TIMED_OUT           = 522,
  HTTP_STATUS_ORIGIN_UNREACHABLE             = 523,
  HTTP_STATUS_ORIGIN_TIMEOUT                 = 524,
  HTTP_STATUS_ORIGIN_SSL_HANDSHAKE_FAILED    = 525,
  HTTP_STATUS_ORIGIN_INVALID_SSL_CERTIFICATE = 526,
  HTTP_STATUS_ORIGIN_DNS_ERROR               = 530
};
