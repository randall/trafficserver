...
Log::init_fields()
{
  ...
  field = new LogField("proxy_resp_result_reason", "psr", LogField::STRING, &LogAccess::marshal_proxy_resp_result_reason,
                       (LogField::UnmarshalFunc)&LogAccess::unmarshal_str);
  global_field_list.add(field, false);
  ink_hash_table_insert(field_symbol_hash, "psr", field);
