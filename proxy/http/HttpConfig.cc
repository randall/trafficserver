...
HttpConfig::startup()
{
  ...
  HttpEstablishStaticConfigByte(c.expanded_500s_enabled, "proxy.config.http.expanded_500s");
...
#define INT_TO_BOOL(i) ((i) ? 1 : 0);
  ...
  params->expanded_500s_enabled      = INT_TO_BOOL(m_master.expanded_500s_enabled);
